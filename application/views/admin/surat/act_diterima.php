    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <?php echo form_open_multipart('Register/'.$act.'_diterima/'); ?>
                            ...
                            <div class="masked-input">
                                <div class="col-md-4 col-red">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date date-picker" name="tgl_diterima" placeholder="contoh : 30/07/2016" value="<?php echo $tgl_disposisi;?>" required>
                                        </div>
                                    </div>
                                </div>
                        	</div>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-12 col-red">
                                <b>Catatan Diterima (Diisi Nama Penerima dan Deskripsi Surat) :</b>
                                <div class="input-group">
                                    <div class="form-line">
                                        <textarea class="form-control no-resize auto-growth" style="overflow: hidden; overflow-wrap: break-word; height: 32px;" placeholder="ENTER untuk menambah baris" rows="1"  class="form-control" placeholder="" name="catatan_diterima" required><?php echo $isi_disposisi;?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
