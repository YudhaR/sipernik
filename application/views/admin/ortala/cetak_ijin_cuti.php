<?php
if($jenis_ijin==1){
	$url = base_url("resources/template/ijin_tidak_masuk.rtf");	
}elseif($jenis_ijin==2){
	$url = base_url("resources/template/ijin_cuti_sakit.rtf");	
}elseif($jenis_ijin==3){
	$url = base_url("resources/template/ijin_cuti_tahunan.rtf");	
}elseif($jenis_ijin==4){
	$url = base_url("resources/template/ijin_cuti_besar.rtf");	
}elseif($jenis_ijin==5){
	$url = base_url("resources/template/ijin_cuti_bersalin.rtf");	
}elseif($jenis_ijin==6){
	$url = base_url("resources/template/ijin_cuti_alasan_p.rtf");	
}
...
$Template = str_replace('#tgl_diijinkan#',''.$tgl_diijinkan.'',$Template);
