<div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                  <form method="post" action="<?php echo base_url().'Kepegawaian/cetak_sppd';?>" enctype="multipart/form-data">                  
                  <div class="row clearfix">
                          <div class="col-md-12 col-red">
                            <b>Pegawai yang Dinas Luar </b>                            
                            <select name="pegawai" class="form-control" required>
                              <?php                            
                              if(!empty($pegawai_sppd)){                                  
                                  foreach ($pegawai_sppd as $row){
                                    $id=$row->id;
