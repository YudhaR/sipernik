        ...
        function togle_full(){
            var a=($('#togle_full').text())
            var text=a.replace(/\s/g, '');
            if (text=="Fullscreen") {
                $('#togle_full').text('Normal ');
                $('#togle_full').append(' <i class="fa fa-desktop"> </i>');
                $('.theme-teal').addClass('ls-closed');
                $('.bars').hide();
                $('#header').fadeOut();
                $('#status_bar').removeClass('m-t-80');
                $('#konten').removeClass('p-t-60');

            }else{
                $('#togle_full').text('Fullscreen ');
                $('#togle_full').append(' <i class="fa fa-desktop"> </i>');
                $('.theme-teal').removeClass('ls-closed');
                $('.bars').show();
                $('#header').fadeIn();
                $('#status_bar').addClass('m-t-80');
                $('#konten').addClass('p-t-60');
